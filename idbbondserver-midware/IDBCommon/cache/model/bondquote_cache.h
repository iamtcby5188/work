...
#ifndef BONDQUOTE_CACHE_H_
#define BONDQUOTE_CACHE_H_
...
typedef std::tr1::shared_ptr<BondQuoteCache> BondQuoteCachePtr;
typedef std::tr1::shared_ptr<std::vector<BondQuoteCachePtr> > BondQuoteCacheVecPtr;
...
public:
    ...
    static BondQuoteCachePtr fromBondQuoteReferCache(BondQuoteReferCache* ref_cache);
