...
std::string BondQuoteCache::SCHEMA_NAME = SCHEMA_IDB_BOND;
std::string BondQuoteCache::TABLE_NAME = "bond_offer";
std::string BondQuoteCache::PKEY_NAME = "id";
std::string BondQuoteCache::SQL_TAG = "FetchBondQuoteSQL";

BondQuoteCache::BondQuoteCache() {
    ...
    spread = DOUBLE_NULL;
    yield = DOUBLE_NULL;
    return_point = DOUBLE_NULL;
    cdc_offset = DOUBLE_NULL;
    create_time_milli_sec = deal_time_milli_sec = -1;
    calculate_status = 1;
    quote_type = "0";
    exercise = "1";
	val_modified_duration = DOUBLE_NULL;
...
std::string BondQuoteCache::getPrimaryKey() {
	return id;
}

void BondQuoteCache::loadCombinationFields() 
{
...
void BondQuoteCache::loadBondSmallViewFields() 
{
...
void BondQuoteCache::loadTradingInstitutionFields()
{
...
void BondQuoteCache::loadTraderFields()
{
...
void BondQuoteCache::loadBrokerFields()
{
...
void BondQuoteCache::loadCdcValuationFields()
{
	cdc_valuation_yield = "";
	cdc_valuation_yield = "";
	cdc_offset = DOUBLE_NULL;
...
BondQuoteCachePtr BondQuoteCache::fromBondQuoteReferCache(BondQuoteReferCache* ref_cache)
{
    BondQuoteCachePtr cache(new BondQuoteCache());
