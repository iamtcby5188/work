...
#ifndef BONDDEAL_CACHE_H_
#define BONDDEAL_CACHE_H_

#include "bondsmallview_cache.h"

class BondDealCache;
typedef std::tr1::shared_ptr<BondDealCache> BondDealCachePtr;
typedef std::tr1::shared_ptr<std::vector<BondDealCachePtr> > BondDealCacheVecPtr;
...
public:
	BondDealCache();
	virtual ~BondDealCache();
	std::string getPrimaryKey();

	bool operator ==(const BondDealCache &rhs);
	bool operator !=(const BondDealCache &rhs);
