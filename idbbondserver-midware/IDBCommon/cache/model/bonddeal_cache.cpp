...
std::string BondDealCache::SCHEMA_NAME = SCHEMA_IDB_BOND;
std::string BondDealCache::TABLE_NAME = "bond_deal";
std::string BondDealCache::PKEY_NAME = "id";
std::string BondDealCache::SQL_TAG = "FetchBondDealSQL";

BondDealCache::BondDealCache() {
...
std::string BondDealCache::getPrimaryKey() {
	return id;
}

bool BondDealCache::operator==(const BondDealCache &rhs) {
...
void BondDealCache::loadCombinationFields() {
...
void BondDealCache::loadBondSmallViewFields() {
...
void BondDealCache::loadTradingInstitutionFields() {
...
void BondDealCache::loadTraderFields() {
...
void BondDealCache::loadBrokerFields() {
...
void BondDealCache::loadCdcValuationFields() {
	cdc_valuation_yield = "";
	cdc_valuation_yield = "";
