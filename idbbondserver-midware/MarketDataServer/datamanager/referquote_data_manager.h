#ifndef _REFER_QUOTE_DATA_MANAGER_H_
#define _REFER_QUOTE_DATA_MANAGER_H_
...
class ReferQuoteDataManager : public sdbus::Callback {

public:   
    ReferQuoteDataManager(sdbus::Connection *conn, std::string companyId);
    ~ReferQuoteDataManager();
    ...
    bool FetchReferQuoteRemote();
    bool FetchIncrementReferQuoteRemote(int version);
...
#endif // _REFER_QUOTE_DATA_MANAGER_H_