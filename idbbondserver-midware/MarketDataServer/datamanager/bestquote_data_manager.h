#ifndef _BESTQUOTE_DATA_MANAGER_H_
#define _BESTQUOTE_DATA_MANAGER_H_
...
class BestQuoteDataManager : public sdbus::Callback {

public:   
    BestQuoteDataManager(sdbus::Connection *conn, std::string companyId);
    ~BestQuoteDataManager();
    ...
    bool FetchBestQuoteRemote();
    bool FetchIncrementBestQuoteRemote(int version);
