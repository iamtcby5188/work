#ifndef _BROKER_BINDING_DATA_MANAGER_H_
#define _BROKER_BINDING_DATA_MANAGER_H_
...
class BrokerBindingDataManager : public sdbus::Callback {

public:   
    BrokerBindingDataManager(sdbus::Connection *conn, std::string companyId);
    ~BrokerBindingDataManager();
    ...
    bool FetchBrokerBindingRemote();
    bool FetchIncrementBrokerBindingRemote(int version);
...
#endif // _BROKER_BINDING_DATA_MANAGER_H_