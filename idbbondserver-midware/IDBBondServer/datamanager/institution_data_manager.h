#ifndef _INSTITUTION_DATA_MANAGER_H_
#define _INSTITUTION_DATA_MANAGER_H_
...
class InstitutionDataManager : public sdbus::Callback {

public:   
    InstitutionDataManager(sdbus::Connection *conn, std::string companyId);
    ...
    bool FetchInstitutionRemote();
    bool FetchIncrementInstitutionRemote(int version);
...
#endif // _INSTITUTION_DATA_MANAGER_H_