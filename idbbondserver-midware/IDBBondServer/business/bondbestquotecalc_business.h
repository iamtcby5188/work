...
{
public:
    void MakeAllBestPrice();
    BondBestQuoteCachePtr MakeBestPrice(const std::string& bond_key_listed_market, bool update = true);
    ...
    std::vector<BondBestQuoteCachePtr> UpdateTime(const std::string& bond_key, const std::vector<std::string>& bond_key_listed_market_vec);    
    static void UpdateTimeCallBack(BondBestQuoteCache* cache, void* param);
    static void UpdateTimeSuccessed(BondBestQuoteCache* cache, void* param);
    static void UpdateTimeFailed(BondBestQuoteCache* cache, void* param);
...
protected:
    ...
    BondBestQuoteCachePtr UpdateBestPrice(const std::string& bond_key_listed_market, bool update);
...
private:
	...
	std::string getDesc(const BondQuoteCachePtr& cache);
};
